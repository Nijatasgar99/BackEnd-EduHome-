        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    City = table.Column<string>(maxLength: 3000, nullable: true),
                    About = table.Column<string>(maxLength: 3000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QuestionNumber = table.Column<string>(maxLength: 200, nullable: true),
                    HeaderLogo = table.Column<string>(maxLength: 1000, nullable: true),
                    FooterLogo = table.Column<string>(maxLength: 1000, nullable: true),
                    FooterText = table.Column<string>(maxLength: 1500, nullable: true),
                    FacebookUrl = table.Column<string>(maxLength: 1000, nullable: true),
                    PinterestUrl = table.Column<string>(maxLength: 1000, nullable: true),
                    VimeUrl = table.Column<string>(maxLength: 1000, nullable: true),
                    TwitterUrl = table.Column<string>(maxLength: 1000, nullable: true),
                    Address = table.Column<string>(maxLength: 1000, nullable: true),
                    PhoneNumber1 = table.Column<string>(maxLength: 2000, nullable: true),
                    PhoneNumber2 = table.Column<string>(maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(maxLength: 1000, nullable: true),
                    Context = table.Column<string>(maxLength: 3000, nullable: true),
                    BackgroundImage = table.Column<string>(maxLength: 1000, nullable: true),
                    OverImage = table.Column<string>(maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Image = table.Column<string>(maxLength: 1000, nullable: true),
                    Context = table.Column<string>(maxLength: 4000, nullable: true),
                    About = table.Column<string>(maxLength: 3000, nullable: true),
                    HowToApply = table.Column<string>(maxLength: 3000, nullable: true),
                    Certification = table.Column<string>(maxLength: 3000, nullable: true),
